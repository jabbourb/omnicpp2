...
func! g:TestLocalType()
    ...
    call g:Assert (omnicpp#declare#LocalType('b') == s:CreateType('int', 1, 0))
    call g:Assert (omnicpp#declare#LocalType('c4') == s:CreateType('int', 0, 1))
...
func! g:TestLocalVars()
    ...
    call g:Assert (omnicpp#declare#LocalVars('c') == ['c4'])
    call g:Assert (empty(omnicpp#declare#LocalVars('anUnlikelyBase')))
endfunc

func! g:TestVars()
    call g:Assert (sort(omnicpp#declare#Vars('c')) == ['c1', 'c2', 'c3', 'c4', 'c5', 'c7'])
endfunc
